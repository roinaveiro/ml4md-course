---
title: "_De-novo_ Molecular Design using ML"
author:
- "Roi Naveiro (CUNEF)"
...
::: {.column width="55%"}
![](session2_files/m1.png){.absolute top=50}
![](session2_files/canSMI.png){.absolute top=400}
:::
:::
...
![](session2_files/drug.png){.absolute top=350 left=200 width="700" height="320"}
...
![](session2_files/chemical-space.jpeg){.absolute top=250  left=250 width="550" height="350"}
...
![](session2_files/ibup.png){.absolute left=350 left=0 width="350" height="220"}
...
::: {.column width="55%"}
![](session2_files/graphmol.png){.absolute left=600 width="400" height="600"}
:::
:::
...
![](session2_files/3d.png){.absolute left=350 left=0 width="350" height="220"}
...
![](session2_files/gn.png){}

## GN Block - Computations

![](session2_files/fullGN.png){}

## MPNN Block - Computations

![](session2_files/MPNN.png){}
...
![](session2_files/cov.png){.absolute left=120 height="500"}


## Hands-on!

![](session2_files/hs.jpeg){.absolute left=230 top=130 height="500"}